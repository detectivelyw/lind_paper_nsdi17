...
In theory, running a program in an operating system virtual machine(OSVM), such as 
VirtualBox, VMWare workstation, and Docker should prevent it from triggering 
zero-day bugs in the host OS kernel.  However, to be 
...
The small (8K LOC) sandbox kernel of Repy contains flaws in SafePOSIX 
