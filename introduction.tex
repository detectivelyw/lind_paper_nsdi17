...
In theory, running a program in an operating-system-level virtual machine (OSVM) like Docker and LXC should 
...
OSVM's containment and interact directly with the host OS. 
...
bugs occur in the large amount of complex code needed for such a system, these 
flaws leave tens of millions of user machines at risk~\cite{linux-0day}.
...
zero-day flaw.  This may occurs even while the containment of the OSVM is 
working as designed.
The reason this occurs is that many of the system calls made within an OSVM eventually 
...
%examples indicate, the design of secure systems has been somewhat, hit-or-miss.â
...
more frequently found in software testing, as they are frequently executed by
diverse pieces of software.
We performed a quantitative analysis of resilience 
to flaws in two versions of the Linux kernel (Linux kernel version 3.13.0 and version 3.14.1), and
