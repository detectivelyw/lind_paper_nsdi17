...
VirtualBox and VMWare Workstation are commercial OSVM products, while
...
\hline
 ...
 CVE-2015-5706 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\multirow{1}{1cm}{{\color{red}\ding{51}}} & \multirow{1}{1cm}{{\ding{55}}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55}  \\

 CVE-2015-0239 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\ding{55}}} &
 \ding{55}  & \ding{55}  \\
 ...
 CVE-2014-9529 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}}  &
\ding{55}  & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55}& \ding{55} &
\ding{55}  & \ding{55}  \\

 CVE-2014-9322 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}}  &
...
\\
 ...
 CVE-2014-8989 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\multirow{1}{1cm}{{\color{red}\ding{51}}} & \multirow{1}{1cm}{{\ding{55}}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55}  \\
 ...
 CVE-2014-8160 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55} & \ding{55} &
\ding{55}  & \ding{55}  \\

 CVE-2014-8134 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}}  & \ding{55}
\\

 CVE-2014-8133 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}}  &
\ding{55}  & \ding{55} & \ding{55} &
\ding{55} & \ding{55} &
\ding{55}  & \ding{55}  \\

 CVE-2014-8086 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
...
\ding{55} & \ding{55}  \\
 ...
 CVE-2014-7826 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \ding{55} & \ding{55}  &
\ding{55} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}}  & \ding{55}
\\

 CVE-2014-7825 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \ding{55} & \ding{55} &
\ding{55} & \ding{55} & \multirow{1}{1cm}{{\color{red}\ding{51}}}  & \ding{55}
\\
...
\\
 ...
 CVE-2014-4171 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\multirow{1}{1cm}{{\color{red}\ding{51}}} & \multirow{1}{1cm}{{\ding{55}}} &
\multirow{1}{1cm}{{\ding{55}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\multirow{1}{1cm}{{\color{red}\ding{51}}}  \\
...
\\
 ...
 CVE-2014-3940 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}}  &
\ding{55}  & \multirow{1}{1cm}{{\color{red}\ding{51}}} & \multirow{1}{1cm}{{\color{red}\ding{51}}} &
\ding{55} & \ding{55} &
\ding{55}  & \ding{55}  \\

 CVE-2014-3917 & \multirow{1}{.7cm}{{\color{red}\ding{51}}} & {\ding{55}}  &
\ding{55}  & \ding{55} & \ding{55} &
\ding{55} & \ding{55} &
\ding{55}  & \ding{55}  \\
...
\hline
 ...
 {\bf Vulnerabilities Triggered} & \multirow{2}{1cm}{\bf 35/35 (100\%)} & {\bf 0/35 (0.0\%)} &
 {\bf 0/35 (0.0\%)}  & {\bf 8/35 (22.9\%)} & {\bf 12/35 (34.3\%)} & {\bf 0/35 (0.0\%)} & {\bf 0/35 (0.0\%)} &
...
not triggered).
\yiwen{This table may need to be replaced. I only keep it here for now so that we know what the new results look like.}}
...
while the other programs had lower rates: 0/35 (0.0\%) in
VirtualBox,
0/35 (0.0\%)  in VMWare Workstation, 8/35 (22.9\%)  in Docker,
12/35 (34.3\%)  in LXC, 0/35 (0.0\%)  in QEMU, 0/35 (0.0\%)  in KVM,
...
\yiwen{The new results are not entirely in favor of our arguments. We need to do something about this. 
We may want to present the results in a different way, or maybe some extra evaluation tests are necessary.}
...
\begin{tabular}{|l|l|l|l|l|}
  ...
  \hline
  VirtualBox & 0 & 153.0K & 71.1K & 81.9K \\
  \hline
  \multirow{2}{1.5cm}{VMWare Workstation} & \multirow{2}{*}{0} &
  \multirow{2}{*}{140.9K} & \multirow{2}{*}{70.7K} &\multirow{2}{*}{70.2K} \\
  & & & & \\   \hline
  QEMU & 0 & 136.1K & 83.3K & 52.8K \\
  \hline
  KVM & 0 & 146.4K & 83.4K & 63K \\
  \hline
\end{tabular}
