...
due to the strict control on flags and arguments. 
...
if it were something that Lind also supports.}
\yiwen{I tried to provide a better example here.} 
...
to pass down to the kernel, which reaches to risky lines in the kernel and leads to bugs. 
...
\texttt{O\_NONBLOCK}, and \texttt{O\_DSYNC}, which can reach risky lines of code in the kernel.
