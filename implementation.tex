...
To test our \lip design, we used it to implement a secure virtual machine\lois{again, do we need to add "Library OS"?}
...
\yiwen{I tried to fix this. Please see the new content in 5.2.}
...
have to provide complex system functions to user programs, for which we implemented the widely accepted standard POSIX interface on top of Repy.
...
We now offer a more detailed example of how SafePOSIX works by reviewing how it re-creates a file system. \lois{Is this extended example really needed?}
...
necessary step because there of Repy's strict rules about the content of a filename.
