...
To do this, two students used applications for Debian 7.0 , a widely-used and popular open source project, that Popularity Contest~\cite{Top-Packages} deemed the 50 most popular Debian
packages (omitting
...
had been around longer in the BSD \lois{has BSD been defined anywhere?} kernel tended to have fewer bugs (metric 1).
