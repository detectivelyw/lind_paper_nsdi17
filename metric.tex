...
we separated the code into five different age groups. \yanyan{maybe 
identify these 5 groups?}
...
\yanyan{is it possible to create new functionality using old code?}
