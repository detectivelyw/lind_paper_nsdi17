...
However, functionality recreation has two pitfalls: first, if the recreated functionality resides in the TCB of the virtualization system, then vulnerabilities there can expose the host OS to attack as well.
